...
//
//     NOTE: the planner no longer emits Pod or Job steps (the API server
//     rejects in-place runtimeClassName patches for both; see
//     pkg/planner kindMigrationBlocker). Their paths are kept here so
//     plans generated by older versions still render patches and roll
//     back without a panic.
//
